...
let MySqlConnector = class MySqlConnector {
    ...
    createScopedConnection(connection) {
        return __awaiter(this, void 0, void 0, function* () {
            connection.initialize(yield this.pool.getConnection());
            return connection;
        });
    }
    releaseConnection(connection) {
        var _a;
        (_a = connection.connection) === null || _a === void 0 ? void 0 : _a.release();
    }
};
MySqlConnector = __decorate([
    (0, paradigm_web_di_1.Injectable)({ lifeTime: paradigm_web_di_1.DependencyLifeTime.Singleton }),
